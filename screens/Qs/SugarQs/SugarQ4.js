...
class SugarQ4 extends Component {
  render() {
  ...
  key: null
    ...
    return (
      ...
      <View style={contentContainer}>
        ...
        <ProgressBar
        progress={1} width={PROGRESS_WIDTH} height={7} unfilledColor='white' borderWidth={0}
        />
        </View>
        ...
        {'Tip: One serving is the size of a tennis ball'}
        </Text>
        </View>
