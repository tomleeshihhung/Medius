...
class SugarQ3 extends Component {
  render() {
  ...
  key: null
    ...
    return (
      ...
      <View style={contentContainer}>
        ...
        <ProgressBar
        progress={0.75} width={PROGRESS_WIDTH} height={7} unfilledColor='white' borderWidth={0}
        />
        </View>
