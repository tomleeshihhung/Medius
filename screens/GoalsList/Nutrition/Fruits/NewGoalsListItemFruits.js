...
import {
  RemindMeListItemFruits, ServingsListItemFruits, DaysListItemFruits
} from '../../Nutrition/Fruits';
import { fruitsChanged } from './goalsActionsFruits';
...
class NewGoalsListItemFruits extends Component {
  ...
  onPress = async () => {
    ...
    if (this.props.data.option === 'Start Goal') {
      ...
      title: 'Fruits',
      day: this.props.fruitsDaysSelected,
      serving: this.props.fruitsServingsSelected,
      remindMe: this.props.fruitsRemindMeSelected,
      friends: 0,
      startDate: todayDate,
      daysLeft: 14,
      key: count,
    ...
    if (this.props.data.option === 'At') {
      ...
      <View style={styles.subContainer2}>
        <DatePicker
         ...
         onDateChange={
           (date) => { this.props.fruitsChanged({ prop: 'fruitsAt', value: date }); }}
  ...
  flatList = () => {
    if (this.props.data.option === 'Remind me') {
      return (
        ...
        <FlatList
          data={this.props.fruitsRemindMe}
    ...
    if (this.props.data.option === 'Servings a day') {
      return (
        <View style={{ height: '100%', width: '100%', justifyContent: 'flex-start' }}>
        <FlatList
          data={this.props.fruitsServings}
          extraData={this.props}
...
const mapStateToProps = (state) => {
  return {
    ...
    fruitsServings: state.nutritionGoalsFruits.fruitsServings,
    fruitsServingsSelected: state.nutritionGoalsFruits.fruitsServingsSelected,
    fruitsAt: state.nutritionGoalsFruits.fruitsAt,
...
export default connect(mapStateToProps, {
  fruitsChanged, goalsChanged, dailyGoalAdd
